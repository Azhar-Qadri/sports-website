...
<title>:: WebMasters Infotech - News Table ::</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <section class="boxs ">
                                ...
                                <a  class="btn btn-raised btn-primary" href="news_manage.php">Add News</a>
                              </h3>
                            </div>
                        ...
                        if($row['status']==1){
                         ...
                         ?>
                                 ...
                                 <td>
                                    <?php 
                                       echo "<a href='news_manage.php?edit&id=".$row['id']."'><i class='fa fa-edit' style='color:blue;font-size: 20px'></i></a>";
                                 ...
                                 <td><img height="100px" width="100px" src="media/news/<?php echo $row['image']; ?>"></td>
